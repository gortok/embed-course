...
static CPU_STK  g_orchestrator_stack[TASK_STACK_SIZE];
...
void startup_task (void * p_arg)
{
    ...
    OSTaskCreate(&g_orch_tcb, "orchestrator", orchestrator_task, (void *)0, HIGH_PRIORITY, &g_orchestrator_stack[0], 10, TASK_STACK_SIZE, 5, 0, (void *)0,0,&err);
